...
For each Task and Variant the Task was executed 1000 times and the execution time was recorded. The benchmark results
can be seen under
`/src/main/resources/testResults`, they include the raw results as csv and some graphics. The Tests can be found
under `/src/test/java`.
