...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, TimeoutException {
        ParallelImageProcessor processor = new BrightnessProcessor(threadPoolSize, 60);
        ProcessorResult result = processor.processImage(
                new File("src/main/resources/images/original/nature/4" +
                        ".nature_mega.jpeg"), ProcessorTaskType.NON_BLOCKING);
        ImageIO.write(result.getImage(), "jpeg",
                new File("src/main/resources/testResults/brightness/nonBlocking/4.nature_mega_new.jpeg"));
    }
}
